...
public class MainActivity extends Activity implements AdListener {
	...
	private String publisherIdForBannerAds = "ENTER_PUBLISHER_ID_HERE"; // your publisher IDs. NOTE: After you close the app, the Publisher IDs will be saved and used instead of values entered here.
	private String publisherIdForInterstitialAds = "ENTER_PUBLISHER_ID_HERE"; // you can reset entered Publisher IDs by re-installing the application.
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adManager = new AdManager(this, "http://my.mobfox.com/request.php", publisherIdForInterstitialAds, true);
		...
		// adTypes.add("app");
		nativeAdManager = new NativeAdManager(this, "http://my.mobfox.com/request.php", true, publisherIdForNativeAds, createNativeAdListener(), null); // passing null as allowed ad types (last parameter), to indicate that there are no restrictions
	...
	public void onClickShowBanner(View view) {
		...
		bannerView = new AdView(this, "http://my.mobfox.com/request.php", publisherIdForBannerAds, true, true);
